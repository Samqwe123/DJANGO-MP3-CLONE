...
class Song (models.Model):
    ...
    def yt_link_modify(self):
        ...
        return f"https://www.youtube.com/embed/{video_id}?autoplay=1&controls=0&showinfo=0&autohide=1&enablejsapi=1"



class PlayList(models.Model):
    name = models.CharField(max_length=100)
    user = models.ForeignKey(User , on_delete=models.CASCADE , related_name="playlists") #many ro one
